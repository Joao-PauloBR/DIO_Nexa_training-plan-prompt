...
Para facilitar a visualização e permitir que o usuário possa baixar e modificar o conteúdo, o PROMPT completo utilizado para a criação do plano de treinamento encontra-se em um arquivo à parte chamado ['PROMPT do Plano de Treinamento.md'](https://github.com/Joao-PauloBR/DIO_Nexa_training-plan-prompt/blob/main/PROMPT%20do%20Plano%20de%20Treinamento.md).
